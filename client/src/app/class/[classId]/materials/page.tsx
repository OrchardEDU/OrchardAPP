...
export default function MaterialsPage() {
	...
	const classData = {
		...
		sociology101: {
			title: 'Sociology 101',
			subtitle: 'Introduction to Sociology',
			icon: '👥',
			students: '26',
			term: '2023-2024',
		},
	...
	const courseMaterials = [
		{
			...
			icon: '📄',
			description:
				'Introduction to fundamental concepts of calculus including limits, derivatives, and integrals',
		...
		},
		{
			...
			icon: '📊',
			description:
				'PowerPoint presentation covering limit concepts, properties, and calculation methods',
		...
		},
		{
			...
			icon: '📝',
			description:
				'Template for submitting homework assignments with proper formatting guidelines',
		...
		},
		{
			...
			icon: '🎥',
			description:
				'Recorded lecture video explaining derivative concepts with visual examples',
		...
		},
		{
			...
			icon: '📚',
			description:
				'Collection of practice problems with step-by-step solutions for derivative calculations',
		...
		},
		{
			...
			icon: '🧮',
			description:
				'Interactive web-based calculator for practicing derivative and integral calculations',
		...
		},
		{
			...
			icon: '📖',
			description:
				'Comprehensive study guide covering all topics for the upcoming midterm examination',
						...
						<div className="activity-item">
							...
							<div className="activity-details">
								...
								<div className="activity-subtitle">
									{currentClass.title} - Derivatives Quiz
								</div>
								...
								<div key={material.id} className="material-detailed-card">
									<div className="material-card-header">
										...
										<div className="material-card-info">
											<h3 className="material-title-large">
												{material.title}
											</h3>
